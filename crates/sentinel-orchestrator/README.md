...
**Library for Autonomous Resource Orchestration in ESNODE Sentinel.**
...
This library is designed to be embedded within `esnode-sentinel`.
...
Or via CLI flag:
```bash
esnode-sentinel --enable-orchestrator=true
```
