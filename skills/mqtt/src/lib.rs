use sentinel_core::drivers::{Driver, Reading, SensorType};
...
impl Default for MqttConfig {
    fn default() -> Self {
        Self {
            ...
            port: 1883,
            client_id: "sentinel-mqtt".to_string(),
            username: None,
            password: None,
...
mod tests {
    ...
    async fn test_mqtt_driver_lifecycle() {
        let config = MqttConfig {
            ...
            port: 1883,
            client_id: "sentinel-test".to_string(),
            username: None,
            password: None,
            topics: vec!["sentinel/test".to_string()],
            qos: 0,
            use_tls: false,
            ca_cert_path: None,
            client_cert_path: None,
